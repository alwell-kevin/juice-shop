...
export function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    const escapedCriteria = criteria.replace(/[\\%_]/g, '\\$&')
    models.sequelize.query('SELECT * FROM Products WHERE ((name LIKE :criteria ESCAPE \'\\\' OR description LIKE :criteria ESCAPE \'\\\') AND deletedAt IS NULL) ORDER BY name', {
